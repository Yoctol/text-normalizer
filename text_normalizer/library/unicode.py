...
from ..factory import UnicodeMapping
from text_normalizer import ROOT_DIR


unicode__chinese_characters_text_normalizer = UnicodeMapping(
...
unicode__chinese_characters_and_digits_text_normalizer = UnicodeMapping(
    unicode_mapping_path=join(
        ROOT_DIR,
...
unicode__english_characters_and_digits_text_normalizer = UnicodeMapping(
    unicode_mapping_path=join(
        ROOT_DIR,
...
unicode__english_digits_and_full_punctuations_text_normalizer = UnicodeMapping(
    unicode_mapping_path=join(
        ROOT_DIR,
...
unicode__chinese_english_digits_and_full_punctuations_text_normalizer = UnicodeMapping(
    unicode_mapping_path=join(
        ROOT_DIR,
