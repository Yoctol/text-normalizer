...
class DateTextNormalizersTestCase(TestCase):
    ...
    def test_date_yymmdd_normalize(self):
        test_cases = [
            ...
            ('今天日期是2017-12-07', ('今天日期是_date_', {'_date_': ['2017-12-07']})),
            ('2017-12-07XD', ('_date_XD', {'_date_': ['2017-12-07']})),
            ('現在日期2017-12-07XD', ('現在日期_date_XD', {'_date_': ['2017-12-07']})),
            ('2017-12-07-00', ('2017-12-07-00', {'_date_': []})),
            ('2017-12-0708', ('2017-12-0708', {'_date_': []})),
            ('2017-1208-07', ('2017-1208-07', {'_date_': []})),
            ('2017-12-07和2018-01-10', ('_date_和_date_',
    ...
    def test_date_yymmdd_denormalize(self):
        normal_test_cases = [
            ...
            ('現在日期_date_', {'_date_': ['2017-12-18']}, '現在日期2017-12-18'),
            ('_date_XD', {'_date_': ['2017-12-18']}, '2017-12-18XD'),
            ('現在日期_date_XD', {'_date_': ['2017-12-18']}, '現在日期2017-12-18XD'),
            ('_date_和_date_', {'_date_': ['2017-12-18', '2018-01-02']}, '2017-12-18和2018-01-02'),
            ('_date__date_', {'_date_': ['2017-12-18', '2018-01-02']}, '2017-12-182018-01-02'),
        ...
        with self.assertRaises(ValueError):
            date_text_normalizer_yymmdd.denormalize(
                sentence='_date_和_date_這兩個日期都沒有雞排',
